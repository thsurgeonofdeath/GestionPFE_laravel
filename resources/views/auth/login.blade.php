...
<x-guest-layout>
        <div class="sidenav">
            <div class="login-main-text">
               ...
               <h2>
                   <a href="" style="font-weight: bold; color: white;" class="typewrite" data-period="2000" data-type='["Ecole Nationale des Sciences appliquées de Fès", "Bonjour cher Etudiant",  " Connectez-vous à votre Espace par là." ]'>
 ...
 <h2 class="text-center" style="color: #032c6a; font-weight: bold ;">CONNEXION A L'ESPACE  ETUDIANTS</h2>
